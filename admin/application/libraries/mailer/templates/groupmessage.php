...
<section style="max-width: 75%; margin: 0 auto; font-family: 'Montserrat', serif;">
	<div style="text-align: center; margin-top: 30px;" width="115">
	...
	<h1 style="max-width: 85%; margin: 30px auto; font-size: 1.2rem; display: flex; border-radius: 3px; border: 1px solid #f2f2f2; background-color: #fff; text-align: center; padding: 15px;">
		<img src="{temp_url}{photo}" style="max-width: 100%;"><br>
		<div>{message}</div>
	</h1>
