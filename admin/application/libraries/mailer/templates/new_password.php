...
<section style="max-width: 75%; margin: 0 auto; font-family: 'Montserrat', serif;">
	...
	<h1 style="text-align: center; font-weight: 700;">
		Informujemy, że zostało zmienione hasło do Państwa konta w sklepie internetowym:<br>
		<a href="{base_url}">{base_url}</a>
	</h1>
	<h1 style="text-align: center; font-weight: 700;">
		Obecne hasło do konta to:
	</h1>
	<div style="max-width: 25%; margin: 30px auto; font-size: 1.2rem; display: flex; border-radius: 3px; border: 1px solid #f2f2f2; background-color: #fff; text-align: center; padding: 15px;">
