...
<section style="max-width: 75%; margin: 0 auto; font-family: 'Montserrat', serif;">
	...
	<h1 style="text-align: center; font-weight: 700;">
		Nowe zapytanie z sklepu internetowego<br>
		<a href="{base_url}">{base_url}</a>
	</h1>
	<div style="max-width: 85%; margin: 30px auto; font-size: 1.2rem;">
		<p>Dane kontaktowe:</p>
		{name}<br>
		{email}<br>
		tel. {phone}<br>
		Przetwarzanie danych: {rodo1}<br>
		Zgoda na kontakt telefoniczny lub email: {rodo2}
	</div>
	<div style="max-width: 85%; margin: 30px auto; font-size: 1.2rem; display: block; border-radius: 3px; border: 1px solid #f2f2f2; background-color: #fff; padding: 15px;">
