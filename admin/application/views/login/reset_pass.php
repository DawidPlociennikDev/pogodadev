...
<html lang="en">
  ...
  <body>
    <form method="post" action="<?php echo base_url(); ?>home/reset_pass" class="d-flex align-items-center justify-content-center bg-gray-900 ht-100v">
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
        ...
        <div class="form-group">
          <a href="<?php echo base_url(); ?>" class="tx-info tx-12 d-block mg-t-10 link">&larr; Powrót do logowania</a>
        </div>
