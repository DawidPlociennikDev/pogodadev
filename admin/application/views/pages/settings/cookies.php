                        ...
                        <div class="row">
                            <div class="col-xs-12 form-margin">
                                <div class="form-group ic-cmp-int">
                                    <div class="nk-int-st">
                                        <label class="nk-label">Tytuł</label>
                                        <input type="text" class="form-control" name="cookies_title" value="<?= @$v->cookies_title; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 form-margin">
                                <div class="form-group">
                                    <div class="nk-int-st">
                                        <label class="nk-label">Informacja cookies</label>
                                        <textarea class="form-control" name="cookies" rows="5"><?= @$v->cookies; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
